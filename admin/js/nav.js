...
(function () {
  ...
  var NAV = [
    ...
    /* Manager-only, like Finance: a lead is a stranger's contact details and
       what they told us, which is the company's to answer, not the team's to
       browse. Next to Tasks because that is what an enquiry becomes. */
    { label: 'Leads',         href: '/admin/leads',          icon: '<path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22 6 12 13 2 6"/>', manager: true },
